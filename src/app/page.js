  ...
  let iconComponent = (url, link, name, key) => {
    return (
      <Link key={key} href={link} target="_blank">
        <Image className="icon" src={url} width={32} height={32} alt={name} />
      </Link>
    );
  };
      ...
      <div className="bodyMainContainer">
        <div className="bodyContainerAbout">
          <div className="profil">
            ...
            <div className="contactInfotmation">
              ...
              <div className=" arrow font flex flex-col gap-0">
                ...
                <Link href={DATA.personInfo.cvLink} target="_blank">
                  Download CV (.pdf)
                </Link>
              </div>
          ...
          <div className="personalInfo">
            ...
            <Link className="summaryCta" href={DATA.summary.cta.link}>{DATA.summary.cta.text}</Link>
          </div>
        </div>
      </div>
    </main>
